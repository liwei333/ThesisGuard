...
Evidence cutoff：2026-09-14，`main@bd4b1d7`。

- Current milestone：`post-WP-03 / WP-04 Evidence implementation next`。
...
- WP-04 的 Evidence Domain Contract 已冻结；当前 main 仍是 `CONTRACT_ONLY`。
- `codex/wp04-evidence-persistence@4201ae7` 有未合并的 WP04-01 persistence foundation；不得把它当作 main 或整个 WP-04 已完成。
- Evidence service/API、Thesis、Market、Portfolio、Trade Plan、Discipline、Notification 和 Agent Runtime 尚未实现或仅有设计。
...
├── evidence/       # Evidence domain (contract on main; implementation pending)
...
| WP-04 | Evidence | CONTRACT_ONLY on main; WP04-01 exists on an unmerged branch |
