"""Fail-closed socket guard for the R4 structured collect-only run."""
...
_LOG = Path("/private/tmp/tg-wp04-02-r4.UwcguW/socket-attempts.jsonl")
...
def _block(address: object) -> None:
    ...
    raise RuntimeError("socket connection blocked by R4 collect-only guard")
